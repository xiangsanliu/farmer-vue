        ...
        <el-table :data="fertilizers" style="width: 100%;">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button @click="viewIngredient(scope.row)" plain size="small" type="primary">查看配料</el-button>
        ...
        <el-dialog :visible.sync="dialogVisible" title="添加记录">
          <el-form :model="form">
            ...
            <el-table :data="form.ingredients" style="width: 100%">
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button @click="removeIngredient(scope.$index)" size="small" type="danger">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-form>
...
export default {
  ...
  methods: {
    ...
    viewIngredient: function(row) {
      ...
      _this.httpPost(
        "/api/getIngredientsByFertilizer",
        { fId: row.id },
        responseBean => {
